        ...
        <div class="row">
	      ...
	      <form action="/LibraryManager/membre_delete" method="post" class="col s12">
	        ...
	        <div class="row center">
	          ...
	          <a class="btn waves-effect waves-light orange" href="/LibraryManager/membre_details?id=${membre.prenom}">Annuler</a> <!-- TODO : remplacer idDuMembre par l'id du membre -->
	        </div>
	      </form>
	    </div>	    
      </div>
