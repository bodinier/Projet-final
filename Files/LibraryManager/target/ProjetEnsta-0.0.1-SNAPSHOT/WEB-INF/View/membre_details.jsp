...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>D�tails du membre n�${membre.get_ID()}</h5> <!-- TODO : remplacer 007 par l'id du membre -->
        <div class="row">
	      <form action="/LibraryManager/membre_details?id=${membre.get_ID()}" method="post" class="col s12"> <!-- TODO : remplacer idDuMembre par l'id du membre -->
	        <div class="row">
	          ...
	          <div class="input-field col s4">
	            <input id="prenom" type="text" value="${membre.get_prenom()}" name="prenom"> <!-- TODO : remplacer prenomDuMembre par le pr�nom du membre -->
